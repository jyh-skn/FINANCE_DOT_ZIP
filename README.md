...
- $ \text{ROE} = \frac{\text{당기순이익}}{\text{자본총계}} \times 100 $
- $ \text{ROA} = \frac{\text{당기순이익}}{\text{자산총계}} \times 100 $
- $ \text{순이익률} = \frac{\text{당기순이익}}{\text{매출액}} \times 100 $

안정성 지표:

- $ \text{부채비율} = \frac{\text{부채총계}}{\text{자본총계}} \times 100 $
- $ \text{자기자본비율} = \frac{\text{자본총계}}{\text{자산총계}} \times 100 $
- $ \text{차입금의존도} = \frac{\text{단기차입금} + \text{장기차입금} + \text{사채}}{\text{자산총계}} \times 100 $
...
- $ \text{매출채권회전율} = \frac{\text{매출액}}{\text{매출채권}} $
- $ \text{재고자산회전율} = \frac{\text{매출액}}{\text{재고자산}} $

성장성 지표:

- $ \text{매출액증가율} = \frac{\text{현재 매출액} - \text{전기 매출액}}{\text{전기 매출액}} \times 100 $
- $ \text{영업이익증가율} = \frac{\text{현재 영업이익} - \text{전기 영업이익}}{\text{전기 영업이익}} \times 100 $
